    ...
    return(
      <section className="menu-container center-container">
        ...
        <div className="menu-items">
          ...
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.2. Espresso</h3>
          ...
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.3. Americano</h3>
          ...
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.4. Cappucino</h3>
              <h4 className="menu-item-price">12zł</h4>
            </div>
            <hr className="menu-item-line"/>
          </div>
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.5. Karmelowa kawa mrożona</h3>
          ...
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.6. Rozgrzewająca herbata</h3>
          ...
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.7. Kawa czarna</h3>
              <h4 className="menu-item-price">11zł</h4>
            </div>
            <hr className="menu-item-line"/>
          </div>
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.8. Kawa biała</h3>
              <h4 className="menu-item-price">12zł</h4>
            </div>
            <hr className="menu-item-line"/>
          </div>
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.9. Cafe latte</h3>
          ...
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.2. Fanta</h3>
          ...
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.3. Fuzetea brzoskwinia z hibikusem</h3>
          ...
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.4. Fuzetea brzoskwinia z hibikusem</h3>
              <h4 className="menu-item-price">250ml - 10zł</h4>
            </div>
            <hr className="menu-item-line"/>
          </div>
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.5. Kinley tonic</h3>
          ...
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.6. Sanpellegrino Arnacia Rossa (oranżada włoska)</h3>
          ...
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.7. Woda Kropla Beskidu gaz | niegaz</h3>
          ...
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.8. Lemoniada cytrynowa</h3>
          ...
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.9. Sprite</h3>
              <h4 className="menu-item-price">250ml - 8zł / 500ml - 11zł</h4>
            </div>
            <hr className="menu-item-line"/>
          </div>
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.10. Cola</h3>
              <h4 className="menu-item-price">250ml - 8zł / 500ml - 11zł</h4>
            </div>
            <hr className="menu-item-line"/>
          </div>
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.11. Kinley z nutą owoców jagodowych i jaśminu</h3>
              <h4 className="menu-item-price">250ml - 9zł</h4>
            </div>
            <hr className="menu-item-line"/>
          </div>
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.12. Kinley tonic ZERO z nutą kwiatów z czarnego bzu</h3>
          ...
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.13. Sok Cappy (jabłko, pomarańcza)</h3>
              <h4 className="menu-item-price">250ml - 9zł</h4>
            </div>
            <hr className="menu-item-line"/>
          </div>
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.14. Woda w karafce (mięta, cytryna, pomarańcza)</h3>
          ...
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.2. Fake Mohito</h3>
          ...
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.3. Weak Cubalibre</h3>
              <h4 className="menu-item-price">19zł</h4>
            </div>
            <div className="menu-item-bottom">
              <p className="menu-item-desc">
          ...
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.2. Limoncello malinowe</h3>
          ...
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.3. Mimosa</h3>
              <h4 className="menu-item-price">32zł</h4>
            </div>
            <div className="menu-item-bottom">
              <p className="menu-item-desc">
          ...
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.4. Sicilian Sunset</h3>
              <h4 className="menu-item-price">30zł</h4>
            </div>
            <div className="menu-item-bottom">
              <p className="menu-item-desc">
          ...
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.5. Grejpfrutowa Mimoza</h3>
              <h4 className="menu-item-price">32zł</h4>
            </div>
            <div className="menu-item-bottom">
              <p className="menu-item-desc">
          ...
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.6. Jesienny Aperol</h3>
          ...
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.7. Sweet Cherry</h3>
              <h4 className="menu-item-price">35zł</h4>
            </div>
            <div className="menu-item-bottom">
              <p className="menu-item-desc">
          ...
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.8. Limoncello Spritz</h3>
              <h4 className="menu-item-price">30zł</h4>
            </div>
            <div className="menu-item-bottom">
              <p className="menu-item-desc">
          ...
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.9. Rossini</h3>
          ...
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.10. Hugo ale nie Boss</h3>
          ...
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.11. Very Cherry</h3>
          ...
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.12. Pink Peroni</h3>
              <h4 className="menu-item-price">32zł</h4>
            </div>
            <div className="menu-item-bottom">
              <p className="menu-item-desc">
          ...
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.13. Very Cherry Spritz</h3>
          ...
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.2. Żywiec biały butelka</h3>
          ...
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.3. Żywiec biały 0%</h3>
          ...
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.4. Żywiec butelka</h3>
              <h4 className="menu-item-price">500ml - 16zł</h4>
            </div>
            <hr className="menu-item-line"/>
          </div>
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.5. Żywiec 0%</h3>
              <h4 className="menu-item-price">500ml - 15zł</h4>
            </div>
            <hr className="menu-item-line"/>
          </div>
          ...
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.2. Il Capolavoro Appassimento</h3>
          ...
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.3. Il Capolavoro Primitivo</h3>
              <h4 className="menu-item-price">55zł</h4>
            </div>
            <div className="menu-item-bottom">
              <p className="menu-item-desc">
          ...
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.4. Valmarone Soave</h3>
          ...
          <div className="menu-item">
            <div className="menu-item-top">
              <h3 className="menu-item-name">NO.5. Maestro Sangiovese Primitivo</h3>
